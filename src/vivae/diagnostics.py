...
from .geometry import DecoderIndicatome, EncoderIndicatome, jacobian, metric_tensor
from .mps import MPSDataLoader
from .network import Autoencoder


def decoder_jacobian_determinants(
    model: Autoencoder, x: Union[np.ndarray, torch.tensor], batch_size: int = 256
) -> np.ndarray:
